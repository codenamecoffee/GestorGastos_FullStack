...
namespace GestorGastosAPI.DTOs
{
    public class TransaccionUpdateDto
    {
        ...
        //public bool ActualizarImagen { get; set; } = false;
        //public IFormFile? ImagenInput { get; set; }

        public bool ActualizarComprobante { get; set; } = false;
        public IFormFile? ComprobanteInput { get; set; }
    }
}
